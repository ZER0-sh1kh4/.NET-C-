...
ALTER TABLE ZIPCODE_INFO ADD CONSTRAINT ZIP_CITY_NN CHECK (CITY IS NOT NULL);

ALTER TABLE ZIPCODE_INFO ADD CONSTRAINT ZIP_STATE_NN CHECK (STATE IS NOT NULL);
...
ALTER TABLE INSTRUCTOR_INFO ADD STREET_ADDRESS VARCHAR(50);

ALTER TABLE INSTRUCTOR_INFO ADD CONSTRAINT INSTRUCTOR_ID_PK PRIMARY KEY (INSTRUCTOR_ID);

ALTER TABLE INSTRUCTOR_INFO ADD CONSTRAINT INSTRUCTOR_FN_NN CHECK (INSTRUCTOR_FIRST_NAME IS NOT NULL);

ALTER TABLE INSTRUCTOR_INFO ADD CONSTRAINT INSTRUCTOR_LN_NN
...
ALTER TABLE COURSE_INFO ADD CONSTRAINT COURSE_NO_PK
PRIMARY KEY (COURSE_NO);

ALTER TABLE COURSE_INFO ADD CONSTRAINT COURSE_NAME_NN CHECK (COURSE_NAME IS NOT NULL);

ALTER TABLE COURSE_INFO ADD CONSTRAINT COST_NN
...
ALTER TABLE STUDENT_INFO ADD STREET_ADDRESS VARCHAR(50);

ALTER TABLE STUDENT_INFO ADD CONSTRAINT STUDENT_ID_PK PRIMARY KEY (STUDENT_ID);

ALTER TABLE STUDENT_INFO ADD CONSTRAINT STUDENT_FN_NN
CHECK (STUDENT_FIRST_NAME IS NOT NULL);

ALTER TABLE STUDENT_INFO ADD CONSTRAINT STUDENT_LN_NN
...
CHECK
(
    GRADE_TYPE_CODE IN ('FI', 'HM', 'MT', 'PA', 'PJ', 'QZ')
);
